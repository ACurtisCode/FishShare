...
<h1 class="text-center">Edit Fish</h1>
	<form:form action="/fish/edit/${ fish.id }" method="post" modelAttribute="fish" class="new-fish" >
	<input type="hidden" name="_method" value="put">
		...
		<div class="form-section">
			<form:label path="species" class="form-label">Species</form:label>
		...
		<td><input type="submit" value="Submit" class="form-section btn btn-primary float-end"/></td>
